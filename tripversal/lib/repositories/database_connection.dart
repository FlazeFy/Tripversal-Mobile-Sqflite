...
class DatabaseConnection{
  ...
  _onCreatingDatabase(Database database, int version) async{
    ...
    await database.execute("CREATE TABLE car (id_car INTEGER PRIMARY KEY AUTOINCREMENT, plate TEXT NOT NULL, type TEXT NOT NULL, carname TEXT NOT NULL , location TEXT NOT NULL , price INTEGER NOT NULL , rating INTEGER, driver TEXT NOT NULL, seat INTEGER NOT NULL, tank INTEGER NOT NULL, distance INTEGER NOT NULL, desc TEXT NOT NULL, coordinate_lan TEXT NOT NULL, coordinate_lng TEXT NOT NULL, id_owner INTEGER NOT NULL)");
    ...
    await database.execute("INSERT INTO car(id_car, plate, type, carname, location, price, rating, driver, seat, tank, distance, desc, coordinate_lan, coordinate_lng, id_owner) VALUES(null, 'D 1140 AAB', 'City Car', 'Toyota Raize/2022', 'Bojongsoang', 340000, 5, 'none', 5, 35, 7000, 'Lorem ipsum', '-6.9703190663757475', '107.63220124971892', 1)");
    await database.execute("INSERT INTO car(id_car, plate, type, carname, location, price, rating, driver, seat, tank, distance, desc, coordinate_lan, coordinate_lng, id_owner) VALUES(null, 'D 1910 CDB', 'City Car', 'Toyota Agya/2018', 'Baleendah', 275000, 5, 'Ben Parker', 5, 30, 52000, 'Lorem ipsum', '-6.966456347108785', '107.63854276840046', 2)");
    await database.execute("INSERT INTO car(id_car, plate, type, carname, location, price, rating, driver, seat, tank, distance, desc, coordinate_lan, coordinate_lng, id_owner) VALUES(null, 'D 2410 VBZ', 'City Car', 'Honda Brio Satya/2019', 'Baleendah', 270000, 5, 'Craig Mckay', 5, 30, 31000, 'Lorem ipsum', '-6.99522817304474', '107.62474584142296', 1)");  
    await database.execute("INSERT INTO car(id_car, plate, type, carname, location, price, rating, driver, seat, tank, distance, desc, coordinate_lan, coordinate_lng, id_owner) VALUES(null, 'D 3410 AAC', 'Minibus', 'Toyota Innova/2015', 'Buah Batu', 400000, 5, 'Ben Parker', 8, 50, 127000, 'Lorem ipsum', '-6.966456347108785', '107.63854276840046', 2)");
